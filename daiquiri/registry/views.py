...
from .vo import get_authority_resource, get_availability, get_capabilities, get_resource, get_web_resource
...
def authority(request):
    return HttpResponse(VoresourceRenderer().render(get_authority_resource()), content_type='application/xml')


def web(request):
    return HttpResponse(VoresourceRenderer().render(get_web_resource()), content_type='application/xml')
