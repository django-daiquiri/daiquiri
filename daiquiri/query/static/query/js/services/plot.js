app.factory('PlotService', ['$resource', '$q', '$filter', function($resource, $q, $filter) {
    ...
    service.fetch = function() {
        ...
        // very hacky and ugly but it works and should be enough for the prototype
        if (service.values.y2 && service.values.y3){
        	...
        	return $q.all([
        	            ...
        	            resources.rows.paginate(y3_params).$promise,
        	            ...
        	            service.source = new Bokeh.ColumnDataSource({
        	                data: {
        	                    ...
        	                    y3: results[3].results,
        	                }
        	            });
        	          });
        }
        else if (service.values.y2){
        	var y2_params = angular.extend({}, service.params, {
        	              column: service.values.y2
        	});
        	return $q.all([
    ...
    service.draw_scatter_plot = function() {
        ...
        if (!isNaN(xmin) && !isNaN(xmax) && !isNaN(ymin) && !isNaN(ymax)) {
            ...
            // Y1 Axis
            if (service.symbols.y == 'circle'){
                    var plot1 = figure.circle({
                        x: { field: "x" },
                        y: { field: "y" },
            ...
            else if (service.symbols.y == 'diamond'){
                    var plot1 = figure.diamond({
                        x: { field: "x" },
                        y: { field: "y" },
                        source: service.source,
                        fill_alpha: 0.4,
            ...
            else if (service.symbols.y == 'triangle'){
                    var plot1 = figure.triangle_dot({
                    x: { field: "x" },
                    y: { field: "y" },
                    source: service.source,
                    fill_alpha: 0.4,
            ...
            else if (service.symbols.y == 'star'){
                    var plot1 = figure.star_dot({
                        x: { field: "x" },
                        y: { field: "y" },
                        source: service.source,
                        fill_alpha: 0.4,
            ...
            // Y2 Axis
            if (service.source.data.y2){
                if (service.symbols.y2 == 'circle'){
                    var plot2 = figure.circle({
                        x: { field: "x" },
                        y: { field: "y2" },
                        source: service.source,
                        fill_alpha: 0.4,
                ...
                else if (service.symbols.y2 == 'diamond'){
                    var plot2 = figure.diamond({
                        x: { field: "x" },
                        y: { field: "y2" },
                        source: service.source,
                        fill_alpha: 0.4,
                ...
                else if (service.symbols.y2 == 'trianlge'){
                    var plot2 = figure.triangle_dot({
                        x: { field: "x" },
                        y: { field: "y2" },
                        source: service.source,
                        fill_alpha: 0.4,
                ...
                else if (service.symbols.y2 == 'star'){
                    var plot2 = figure.star_dot({
                        x: { field: "x" },
                        y: { field: "y2" },
                        source: service.source,
                        fill_alpha: 0.4,
            ...
            //Y3 Axis
            if (service.source.data.y3){
                if (service.symbols.y3 == 'circle'){
                    var plot3 = figure.circle({
                        x: { field: "x" },
                        y: { field: "y3" },
                        source: service.source,
                        fill_alpha: 0.4,
                ...
                else if (service.symbols.y3 == 'diamond'){
                    var plot3 = figure.diamond({
                        x: { field: "x" },
                        y: { field: "y3" },
                        source: service.source,
                        fill_alpha: 0.4,
                ...
                else if (service.symbols.y3 == 'triangle'){
                    var plot3 = figure.triangle_dot({
                        x: { field: "x" },
                        y: { field: "y3" },
                        source: service.source,
                        fill_alpha: 0.4,
                ...
                else if (service.symbols.y3 == 'star'){
                    var plot3 = figure.star_dot({
                        x: { field: "x" },
                        y: { field: "y3" },
                        source: service.source,
                        fill_alpha: 0.4,
    ...
    service.draw_histogram = function() {
        ...
        if (!isNaN(xmin) && !isNaN(xmax)) {
            ...
            var histogram_t = new Array(bins).fill(0);
    ...
    service.draw_histogram_2d = function() {
        ...
        var xmin = Math.min.apply(null, service.source.data.x),
            ...
            // construct the histogram
            var bins = Math.floor(Math.sqrt(Math.sqrt(service.source.data.x.length))) + 1;
            var bin_size_x = (xmax - xmin)/(bins-1);
            var bin_size_y = (ymax - ymin)/(bins-1);

            var histogram = new Array(bins);

            for (var i=0;i<bins;i++){
                histogram[i] = new Array(bins).fill(0);
            }
