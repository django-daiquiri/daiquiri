...
urlpatterns = [
    ...
    re_path(
        r'^pending/$',
        TemplateView.as_view(template_name='account/account_pending.html'),
    ...
    re_path(
        ...
        TemplateView.as_view(template_name='account/password_change_done.html'),
        name='account_change_password_done',
    ),  # noqa: E501
    re_path(r'^password/set/$', password_set, name='account_password_set'),
    re_path(
        r'^password/set/done/$',
        TemplateView.as_view(template_name='account/password_set_done.html'),
        name='account_set_password_done',
    ),  # noqa: E501
    re_path(r'^terms_of_use/$', terms_of_use, name='terms_of_use'),
    re_path(r'^signup_webauthn/$', signup_webauthn, name='account_signup_webauthn'),
